...
echo "auto-generated by afni_proc.py, Mon Oct 30 17:12:11 2023"
echo "(version 7.55, March 1, 2023)"
echo "execution started: `date`"

# to execute via tcsh: 
#   tcsh -xef proc_native_sp.sub-00 |& tee output.proc_native_sp.sub-00
# to execute via bash: 
#   tcsh -xef proc_native_sp.sub-00 2>&1 | tee output.proc_native_sp.sub-00
...
set output_dir = $subj.results_native

# verify that the results directory does not yet exist
if ( -d $output_dir ) then
    echo output dir "$subj.results_native" already exists
    exit
endif
...
3dcopy                                                                                                                      \
    /export/home/asanchez/asanchez/conceptmap/data/conceptbids/${subj}/anat/${subj}_acq-t1mpragesagp21isoMGH_run-1_T1w.nii.gz \
    $output_dir/${subj}_acq-t1mpragesagp21isoMGH_run-1_T1w
...
find_variance_lines.tcsh -polort 5 -nerode 2   \
       -rdir vlines.pb00.deobliq                  \
       pb00.$subj.r*.deobliq+orig.HEAD |& tee out.vlines.pb00.deobliq.txt
...
foreach run ( $runs )
    ...
    3dAllineate -base ${subj}_acq-t1mpragesagp21isoMGH_run-1_T1w_ns+orig       \
...
3dcopy ${subj}_acq-t1mpragesagp21isoMGH_run-1_T1w_ns+orig anat_final.$subj
...
3dDetrend -polort 5 -prefix rm.noise.det -overwrite pb02.$subj.r01.volreg+orig
...
foreach run ( $runs )
    3dAutomask -prefix rm.mask_r$run pb02.$subj.r$run.volreg+orig
end
...
#
# afni_proc.py -subj_id sub-00 -script proc_native_sp.sub-00 -scr_overwrite                                                                     \
#     -copy_anat                                                                                                                                \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/anat/sub-00_acq-t1mpragesagp21isoMGH_run-1_T1w.nii.gz                   \
#     -anat_has_skull yes -dsets                                                                                                                \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-1_echo-1_bold.nii.gz \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-2_echo-1_bold.nii.gz \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-3_echo-1_bold.nii.gz \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-4_echo-1_bold.nii.gz \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-5_echo-1_bold.nii.gz \
#     /export/home/asanchez/asanchez/conceptmap/data/conceptbids/sub-00/func/sub-00_task-LexDec_acq-epfid2d188_dir-COL_run-6_echo-1_bold.nii.gz \
#     -blocks tshift align volreg mask blur scale -tcat_remove_first_trs 6                                                                      \
#     -align_opts_aea -cost lpc+ZZ -giant_move -volreg_align_to MIN_OUTLIER                                                                     \
#     -volreg_align_e2a -volreg_compute_tsnr yes -blur_size 4.0
